...
const Page = ({ data }) => {
  ...
  useEffect(() => {
    if(loading || appartmentInfo.listing != undefined ) return;
  ...
  return (
    <>
      ...
      <div className="place">
        ...
        {!loading && appartmentInfo.listing == undefined && (<div>Data not available</div>)}
        {!loading && appartmentInfo.listing != undefined && (<>
        <header>
          <div className="upside">
            <Link className="logo" href={"/"}>
              <Logo />
              <span className="logoicon-name">MCDream </span>
            </Link>
        ...
        <div className="content">
          <main>
            <section className="upx">
              <div className="title">{appartmentInfo.listing.name}</div>
              <div className="details">
                <div className="left">
                  <div className="star">
                    <StarIcon />
                    <p>{appartmentInfo.listing.avgRatingLocalized}</p>
                    <span>· </span>
                  </div>
                  <p className="review">{reviewCount} reviews</p>
                  <p className="host">
                    <span>·</span> <FaLocationDot /> {appartmentInfo.listing.city} <span>·</span>
                  </p>
